                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('proprietarios.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            class="form-control @error('profissao') is-invalid @enderror" id="profissao"
                                            name="profissao" value="{{ old('profissao') }}">
                                        @error('profissao')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <select class="form-select @error('estado_civil') is-invalid @enderror"
                                        ...
                                        <option @if (old('estado_civil') == 'solteiro') selected @endif value="solteiro">
                                            Solteiro(a)</option>
                                        <option id="mostrar_conjuge" @if (old('estado_civil') == 'casado') selected @endif
                                            value="casado">Casado(a)</option>
                                        <option @if (old('estado_civil') == 'divorciado') selected @endif value="divorciado">
                                            Divorciado(a)</option>
                                        <option @if (old('estado_civil') == 'viuvo') selected @endif value="viuvo">
                                            Viúvo(a)</option>
                                        <option @if (old('estado_civil') == 'outro') selected @endif value="outro">Outro
                                        </option>
                                    </select>
                                    @error('estado_civil')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    <label for="comprovante_endereco" class="form-label">Comprovante de
                                        Endereço</label>
                                    <input type="file"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file"
                                        class="form-control @error('uc_energisa') is-invalid @enderror"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file"
                                        class="form-control @error('matricula_agua') is-invalid @enderror"
                                ...
                                <div class="mb-3">
                                    <label for="matricula_imovel" class="form-label">Matrícula do Imóvel ou Contrato
                                        de Compra e venda</label>
                                    <input type="file"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file"
                                        class="form-control @error('guia_iptu') is-invalid @enderror" id="guia_iptu"
                                        name="guia_iptu">
                                    @error('guia_iptu')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file"
                                    class="form-control @error('dados_bancarios') is-invalid @enderror"
